...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001597165437').split()]
...
MSG_ALRT = environ.get('MSG_ALRT', 'Wɪᴛʜ Lᴏᴠᴇ Aʀsᴇɴᴀʟ Bᴏᴛᴢ ❤️')
