...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. Rᴇǫᴜᴇsᴛ ɪɴ ᴀɴʏ Gʀᴏᴜᴘ</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Mʏ Mᴏᴠɪᴇ Gʀᴏᴜᴘ🔎", url=f"https://t.me/New_Movies_Search_Area")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/HelpDesk_XDs")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ', url='https://youtu.be/dQw4w9WgXcQ?si=3nruJJc--fQ2Z_nb')
        ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Shadow_XD_ChatBot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
